...
## Solution
This project is a GenAI-powered legal assistant designed to help SMEs quickly understand business contracts. The application analyzes uploaded contract documents and:
